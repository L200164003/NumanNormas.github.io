...
<body>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12 d-flex align-items-center justify-content-between">
                        <!-- Logo Area -->
                        <div class="logo">
                            <a href="index.php"><img src="img/core-img/logobos.png" alt=""></a>
                        </div>
                        ...
                        <div class="search-login-area d-flex align-items-center">
                            ...
                            <div class="login-area">
                                <a href="Login/Login.php"><span>Login / Register</span> <i class="fa fa-lock" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="Movies-review.php">Games</a>
                                        <ul class="dropdown">
                                            <li><a href="Movies-review.php">Game Review</a></li>
                                    ...
                                    <li><a href="Book-review.php">Books</a>
                                        <ul class="dropdown">
                                            <li><a href="Book-review.php">Books</a></li>
                                            <li><a href="single-post.html">Single Articles</a></li>
                                        </ul>
                                    ...
                                    <li><a href="single-game-review.html">Reviews</a>
                                        <ul class="dropdown">
                                            <li><a href="Movies-review.php">Movies Review</a></li>
                                            <li><a href="Book-review.php">Book Review</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="Write.php">Write your own</a></li>
                                </ul>
                            </div>
                            <!-- Nav End -->
                        </div>
    ...
    <div class="hero-area">
        ...
        <div class="hero-post-slides owl-carousel">
            ...
            <!-- Single Slide -->
            <div class="single-slide bg-img bg-overlay" style="background-image: url(img/bg-img/ww.jpg);">
                <!-- Blog Content -->
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-lg-9">
                            <div class="blog-content" data-animation="fadeInUp" data-delay="100ms">
                                <h2 data-animation="fadeInUp" data-delay="400ms">Kutipan dari Buku</h2>
                                <p data-animation="fadeInUp" data-delay="700ms">Mungkin tanganmu tak pernah merasakan kesepian. Tapi jika merasakannya, sahabatku, ketahuilah bahwa tanganku selalu ada untuk kamu genggam.
<br><b>Samantha King, Born to Love Cursed to Feel</b></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Single Slide -->
            <div class="single-slide bg-img bg-overlay" style="background-image: url(img/bg-img/333170.jpg);">
                <!-- Blog Content -->
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-lg-9">
                            <div class="blog-content" data-animation="fadeInUp" data-delay="100ms">
                                <h2 data-animation="fadeInUp" data-delay="400ms">Kutipan dari Film</h2>
                                <p data-animation="fadeInUp" data-delay="700ms">Bermimpilah setinggi langit, walaupun kalian tidak mencapai langit setidaknya kalian melewati ribuan bintang” <br>  <b>5 cm</b></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-games-area text-center mb-100 wow fadeInUp" data-wow-delay="100ms">
                        <img src="img/bg-img/write.png" alt="">
                        <a href="#" class="btn egames-btn mt-30">Write yours</a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="single-games-area text-center mb-100 wow fadeInUp" data-wow-delay="300ms">
                        <img src="img/bg-img/book.png" alt="">
                        <a href="#" class="btn egames-btn mt-30">View Books</a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="single-games-area text-center mb-100 wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <a href="#" class="btn egames-btn mt-30">View Movies</a>
                    </div>
                </div>
            </div>
        </div>
